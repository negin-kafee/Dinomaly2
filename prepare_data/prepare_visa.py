...
parser.add_argument('--data-folder', default='/Data4/guojia/VisA/', type=str,
                    help='the path to downloaded VisA dataset')
parser.add_argument('--save-folder', default='/Data4/guojia/VisA_pytorch/', type=str,
                    help='the target path to save the reorganized VisA dataset facilitating data loading in pytorch')
parser.add_argument('--split-file', default='/Data4/guojia/VisA/split_csv/1cls.csv', type=str,
